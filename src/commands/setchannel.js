...
module.exports.run = async (client, message, args) => {
    ...
    const channelHere = message.channel.id;
    if (channel.id === channelHere)
        return message.channel.send("You cant \`setchannel\` well you are in the channel");

    client.channel[message.guild.id] = { channelID: channel.id };
